...
class gooplex(Exchange):
    ...
    def fetch_deposit_address(self, code, params={}):
        ...
        response = self.signedGetDepositsAddress(self.extend(request, params))
    ...
    def fetch_deposits(self, code=None, since=None, limit=None, params={}):
        ...
        response = self.signedGetDeposits(self.extend(request, params))
    ...
    def fetch_withdrawals(self, code=None, since=None, limit=None, params={}):
        ...
        if since is not None:
            ...
            # max 3 months range https://github.com/ccxt/ccxt/issues/6495
            request['endTime'] = self.sum(since, 7776000000)
        response = self.signedGetWithdraws(self.extend(request, params))
        return self.parse_transactions(response['data']['list'], currency, since, limit)
    ...
    def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        response = self.signedPostWithdraws(self.extend(request, params))
        return {
            'info': response,
    ...
    def cancel_all_orders(self, symbol=None, params={}):
        ...
        for index in range(0, len(orders)):
            ...
            data = getattr(self, method)(self.extend(request))
    ...
    def fetch_agg_trades(self, symbol, limit=None, params={}):
